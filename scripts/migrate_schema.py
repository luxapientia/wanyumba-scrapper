        ...
        try:
            ...
            try:
                ...
                if "cannot be cast" in str(e) or "already" in str(e):
                    logger.info("Images column already correct type, skipping...")
                    db.rollback()
                else:
            ...
            logger.info("Step 4: Migrating data from seller_info to contact fields...")
            try:
            ...
            logger.info("Step 5: Extracting property details from attributes...")
            try:
                # Extract bedrooms
                db.execute(text("""
                    UPDATE real_estate_listings
            ...
            old_columns = ['views', 'posted_date', 'listing_id', 'image_count', 'scraped_at', 'seller_info']
