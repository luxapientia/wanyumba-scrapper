...
class RealEstateListing(Base):
    ...
    # Source information
    source = Column(String(50), nullable=False, index=True)  # 'jiji', 'kupatana', etc.
    ...
    property_type = Column(String(50), nullable=True, index=True)  # 'apartment', 'house', 'land', 'commercial', 'other'
    listing_type = Column(String(50), nullable=True, index=True)  # 'rent', 'sale'
    status = Column(String(20), nullable=True, index=True)  # 'active', 'inactive', 'unknown'
    
    # Pricing
    price = Column(Float, nullable=True)  # Numeric price value
    price_currency = Column(String(10), nullable=True)  # 'TZS', 'USD', etc.
    price_period = Column(String(20), nullable=True)  # 'once', 'month', 'year', etc.
    ...
    living_area_sqm = Column(Float, nullable=True)  # Living area in square meters
